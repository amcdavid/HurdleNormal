...
test_that('Can fit', {
    ...
    paths1 <- cgpaths(y.zif, this.model, lambda=lambda, control=list(tol=1e-7, maxrounds=3000, debug=1, method='proximal', stepsize=1, updatehess=200, stepexpand=.5), standardize=FALSE)
